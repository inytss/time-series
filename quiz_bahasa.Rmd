...
___
1. Data time series memiliki beberapa karakteristik. Manakah pernyataan di bawah ini yang **TIDAK BENAR** terkait time series?
  - [ ] *Additive time series* disebut additive karena amplitudo/besaran aktivitas *seasonal*-nya cenderung konstan pada periode observasi.
  ...
  - [ ] Data time series selalu memiliki pola tren, *seasonal*, dan *error*
