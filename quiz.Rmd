...
1. Which statement below is **TRUE** based on the time series plot above?
 - [ ] Additive time series is additive because the seasonality pattern is rather constant across the observed period
 - [ ] Multiplicative time series is multiplicative because as the trend increase, the amplitude of seasonal activity is constant
